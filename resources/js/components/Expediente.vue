            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9" v-if="tipoAccion==1">
                  <input type="text" @keyup.enter="registrarCategoria()"  v-model="descripcion" class="form-control" placeholder="Ingrese descripción">
                </div>
                <div class="col-md-9" v-if="tipoAccion==2">
                  <input type="text" @keyup.enter="actualizarCategoria()"  v-model="descripcion" class="form-control" placeholder="Ingrese descripción">
                </div>
              </div>
              <div v-show="errorCategoria" class="row form-btn-group div-error">
  ...
  methods: {
    ...
    desactivarCategoria(id){
      const swalWithBootstrapButtons = Swal.mixin({
                ...
                title: '¿Está seguro que desea desactivar esta categoría?',
                type: 'warning',
    ...
    activarCategoria(id){
      const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                title: '¿Está seguro que desea activar esta categoría?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar',
                cancelButtonText: 'Cancelar',
