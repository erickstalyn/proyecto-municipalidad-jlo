...
class CreateUsuarioTable extends Migration
{
    ...
    public function up() {
        Schema::create('usuario', function (Blueprint $table) {
            ...
            $table->string('contraseña', 100);   // Contraseña.
            ...
            $table->boolean('estado')->default(1);  // Estado. Sirve para permitir o denegar el acceso del puesto a la app. Por ejemplo: (0: desactivado), (1: activado)
